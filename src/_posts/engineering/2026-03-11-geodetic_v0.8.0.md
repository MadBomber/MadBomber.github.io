---
layout: blog_post
title: "Announcing Geodetic 0.8.0: 20 Years of Production GIS Now Open Source"
date: 2026-03-11
categories:
  - Engineering
permalink: /blog/engineering/geodetic-v0.8.0/
tags:
  - Ruby
  - GIS
  - Geospatial
...
# Announcing Geodetic 0.8.0: 20 Years of Production GIS Now Open Source
...
```ruby
# Create paths
route = Path.new([seattle, portland, sf, la])
...
lla.convert_vertical_datum(from: "HAE", to: "NAVD88")
```
...
polygon_union = a.union(b)       # Pure Ruby has no union; GEOS does
```

No API changes — the same code runs with or without GEOS. Set `GEODETIC_GEOS_DISABLE=1` to force pure Ruby even when GEOS is installed.
...
(b1 - Geodetic::Bearing.new(45)).degrees  # => 45.0
```
